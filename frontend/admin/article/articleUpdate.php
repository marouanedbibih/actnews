...
<body>
    <!-- Main modal -->
    <div id="createArticleModal" tabindex="-1" aria-hidden="true" class="flex overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
        <div class="relative p-4 w-full max-w-3xl h-full md:h-auto">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <!-- Modal body -->
                <form action="#" class="grid grid-cols-2 gap-5" id="form-update-article">
    ...
    <script type="module" src="./articleUpdate.js"></script>
